...
<div class="content">
    ...
    <div class="row">
        <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate action="{{ route('administrator.blog.update', Crypt::encrypt($data->id)) }}" method="post">
            @csrf
            @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input name="author" placeholder="author" class="form-control @error('author') is-invalid @enderror" id="author" value="{{ $data->author }}">
