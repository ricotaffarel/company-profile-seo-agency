...
<div class="content">
    ...
    <div class="row">
    <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate action="{{ route('administrator.blog-category.update', Crypt::encrypt($data->id)) }}" method="post">
            @csrf
            @method('PUT')
