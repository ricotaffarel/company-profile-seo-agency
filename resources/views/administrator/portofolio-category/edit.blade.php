...
<div class="content">
    <div class="d-sm-flex align-items-center justify-content-between">
        <div class="pagetitle">
            <h1>Portofolio Category - Update</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="">Portofolio Category</a></li>
    ...
    <div class="row">
    <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate action="{{ route('administrator.portofolio-category.update', Crypt::encrypt($data->id)) }}" method="post">
            @csrf
            @method('PUT')
            <div class="col-lg-12 order-lg-1">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Portofolio Category</h5>
