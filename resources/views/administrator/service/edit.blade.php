...
<div class="content">
    ...
    <div class="row">
        <form class="row g-3 needs-validation" enctype="multipart/form-data" novalidate action="{{ route('administrator.service.update', Crypt::encrypt($data->id)) }}" method="post">
            @csrf
            @method('PUT')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <select class="form-select" name="service_categories_id" aria-label="Default select example">
                                <option selected="">Open this select category</option>
                                @forelse ($service_category as $category)
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input name="name" placeholder="name" value="{{$data->name}}" class="form-control @error('name') is-invalid @enderror" id="name">
